...
@StrutsFunctionality(application = StudentViewApp.class, descriptionKey = "label.title.sync", path = "sync",
        bundle = "resources.MessagingResources", titleKey = "label.title.sync")
