...
@StrutsFunctionality(application = PersonalAreaApp.class, descriptionKey = "label.parking",
        bundle = "resources.ParkingResources", path = "parking", titleKey = "label.parking")
